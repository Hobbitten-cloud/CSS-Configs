...
function spawnNpc(npcType, node) {
	...
	{
		npc = {
			physb = genPhysbox(gmNpcDog.physb, "npc_dog_physb" + npcNumber, 0, spawnOrigin + Vector(0, 0, 88), false, "vscript_npc_dog.nut"),
			physbFilter = genPhysboxFilter("npc_dog_physb" + npcNumber, "npc_dog_filter" + npcNumber),
			model = genModel(gmNpcDog.model, "npc_dog_model" + npcNumber, spawnOrigin - Vector(0, 0, 4), "walk", "vscript_npc_movement.nut"),
			...
			physbHealth = genPhysbox(gmNpcDog.physbHealth, "npc_dog_physb_health" + npcNumber, 0, spawnOrigin + Vector(0, 0, 80), true, "vscript_npc_health.nut"),
		...
		npc.physbHealth.GetScriptScope().initHealthFields(npc.physb, 0, 10);
		npc.physb.GetScriptScope().doAction(NpcAction.update);
	} 
	else if (npcType == 1) 
	{
		npc = {
			physb = genPhysbox(gmNpcHBug.physb, "npc_hbug_physb" + npcNumber, 500, spawnOrigin + Vector(0, 0, 8), false, "vscript_npc_hbug.nut"),
			physbFilter = genPhysboxFilter("npc_hbug_physb" + npcNumber, "npc_hbug_filter" + npcNumber),
			model = genModel(gmNpcHBug.model, "npc_hbug_model" + npcNumber, spawnOrigin - Vector(0, 0, 2), "idle", "vscript_npc_movement.nut"),
			...
			physbHealth = genPhysbox(gmNpcHBug.physbHealth, "npc_hbug_physb_health" + npcNumber, 0, spawnOrigin + Vector(0, 0, 52), true, "vscript_npc_health.nut"),
		...
		npc.physbHealth.GetScriptScope().initHealthFields(npc.physb, 0, 7);
		npc.physb.GetScriptScope().doAction(NpcAction.update);
	}
}
